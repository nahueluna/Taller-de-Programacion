...
public class Pr2_ej1 {

    public static void main(String[] args) {
        //System.out.println("Ingrese el nombre, DNI y edad de la persona");
        Persona p1=new Persona(Lector.leerString(),Lector.leerInt(),Lector.leerInt());
